public class EnemigosEspeciales : EnemigosCPU
{
    public EnemigosEspeciales(int resistencia, int vida, int nivel) : base(vida, nivel, resistencia)
    {
        Random rand = new Random();
        Resistencia = rand.Next(0, 6); 
        DisminucionResistenciaEnTurnos = 0;
    }

    public override void RecibirDanoConResistencia(int danoBase) // No se si esta bien implementada
    {
